...
<head>
    ...
    <title>Login - Creative Portfolio</title>
...
<body class="bg-[#FDFDFC] min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            <h1 class="font-['Dancing_Script'] text-5xl text-[#1b1b18] mb-2">Welcome Back</h1>
            <p class="font-['Anton'] text-lg tracking-widest text-[#0d328f] uppercase">Login to Portfolio</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
                ...
                <div class="flex items-center justify-between">
                    <label class="flex items-center">
                        <input 
                            type="checkbox" 
                            name="remember" 
                            class="w-4 h-4 text-[#0d328f] border-gray-300 rounded focus:ring-[#0d328f]"
                        >
                        <span class="ml-2 text-sm text-gray-600">Remember me</span>
                    </label>
                    <a href="#" class="text-sm text-[#0d328f] hover:underline">Forgot password?</a>
                </div>
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-gray-600">
                    ...
                    <a href="{{ route('register') }}" class="text-[#0d328f] font-medium hover:underline">Register</a>
                </p>
            </div>
        </div>
